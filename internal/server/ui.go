...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> CONCIERGE</h1>
...
<script>
var A='/api';
var RESOURCE='checklists';
var TITLE_FIELD='customer_name';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "customer_name", "label": "Customer Name", "type": "text"}, {"name": "template", "label": "Template", "type": "text"}, {"name": "steps", "label": "Steps", "type": "text"}, {"name": "progress", "label": "Progress", "type": "integer"}, {"name": "assignee", "label": "Assignee", "type": "text"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "due_date", "label": "Due Date", "type": "date"}, {"name": "created_at", "label": "Created At", "type": "text"}];
